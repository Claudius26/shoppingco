...
const TopSelling = ({ limit }) => {
  ...
  useEffect(() => {
    if (products.length > 0) {
      const topSelling = [...products].sort(
  ...
  return (
    <section className="px-4 md:px-20 py-14 bg-gray-50 min-h-[60vh]">
      <div className="flex items-center justify-between mb-8">
        <h2 className="text-4xl font-extrabold text-yellow-700 drop-shadow-md tracking-tight">
